...
1: Divides the code into states. Thus, a different state can be found to the right and to the left of each 1 (even if it looks empty). After the last encoded state is the termination state. 
